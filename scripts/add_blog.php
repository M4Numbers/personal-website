...
if (!isset($_POST['inputBlogTitle']) || !isset($_POST['inputBlogContents']))
{
    die();
}
...
$true_id = $database->add_new_blog($_POST['inputBlogTitle'], $_POST['inputBlogContents']);

$database->registerUpdate(UPDATE_BLOG, $true_id);
